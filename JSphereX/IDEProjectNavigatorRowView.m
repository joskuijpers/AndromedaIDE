...
@interface IDEProjectNavigatorRowView()

@property (assign) BOOL dirtyCall;

@end

@implementation IDEProjectNavigatorRowView
...
- (void)drawSelectionInRect:(NSRect)dirtyRect
{
	...
	[outlineView.selectedRowIndexes enumerateIndexesUsingBlock:
	 ^(NSUInteger idx, BOOL *stop) {
		 ...
		 IDEProjectNavigatorRowView *row = [outlineView rowViewAtRow:idx makeIfNecessary:NO];
		 if(row == nil)
			 return;
